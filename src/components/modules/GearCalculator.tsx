                ...
                <div className="overflow-hidden rounded-xl border border-slate-800">
                    <table className="w-full text-left text-xs">
                        <thead className="bg-slate-900 text-muted-foreground uppercase font-bold">
                            <tr>
                                <th className="px-4 py-3">{t('cogLabel')}</th>
                                <th className="px-4 py-3 text-right">{t('bigRing')} ({front[0]}T)</th>
                                {front[1] && <th className="px-4 py-3 text-right">{t('smallRing')} ({front[1]}T)</th>}
                            </tr>
                        </thead>
